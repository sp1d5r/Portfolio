  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        {/* Animated background elements - fixing z-index to ensure they stay behind content */}
        <motion.div 
          className="absolute left-0 w-72 h-72 rounded-full bg-purple-500/10 -z-10"
          style={{ top: '15%' }}
          animate={{ 
            x: [-100, 0, -100], 
            y: [0, 100, 0],
        ...
        <motion.div 
          className="absolute right-0 w-96 h-96 rounded-full bg-blue-500/10 -z-10"
          style={{ top: '40%' }}
          animate={{ 
            x: [100, 0, 100], 
            y: [0, -100, 0],
